...
export function WorkBrowser({ featured, index }: { featured: Project[]; index: Project[] }) {
    ...
    <>
      ...
      <LayoutGroup>
        {shownFeatured.length > 0 ? (
          <Section number="02" label="Selected work">
        ...
        <Section
          number={shownFeatured.length > 0 ? '03' : '02'}
          label="Index"
